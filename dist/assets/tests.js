...
define('weather-gifs/tests/integration/components/search-input-test', ['qunit', 'ember-qunit', '@ember/test-helpers'], function (_qunit, _emberQunit, _testHelpers) {
  'use strict';

  (0, _qunit.module)('Integration | Component | search-input', function (hooks) {
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "ZAt9XH0K",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"search-input\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "0xWqffoN",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"search-input\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
...
define('weather-gifs/tests/integration/components/search-result-test', ['qunit', 'ember-qunit', '@ember/test-helpers'], function (_qunit, _emberQunit, _testHelpers) {
  'use strict';

  (0, _qunit.module)('Integration | Component | search-result', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "fyJGMmKi",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"search-result\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "60B60RLZ",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"search-result\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
...
define('weather-gifs/tests/lint/app.lint-test', [], function () {
  'use strict';
  ...
  QUnit.test('components/search-input.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/search-input.js should pass ESLint\n\n');
  });

  QUnit.test('components/search-result.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/search-result.js should pass ESLint\n\n5:5 - Only string, number, symbol, boolean, null, undefined, and function are allowed as default properties (ember/avoid-leaking-state-in-ember-objects)');
  });

  QUnit.test('controllers/application.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'controllers/application.js should pass ESLint\n\n31:17 - Unexpected console statement. (no-console)\n48:21 - Unexpected console statement. (no-console)\n52:17 - Unexpected console statement. (no-console)');
  });
...
define('weather-gifs/tests/lint/templates.template.lint-test', [], function () {
  'use strict';

  QUnit.module('TemplateLint');

  QUnit.test('weather-gifs/templates/application.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'weather-gifs/templates/application.hbs should pass TemplateLint.\n\nweather-gifs/templates/application.hbs\n  3:23  error  Incorrect indentation of attribute \'fetchData\' beginning at L3:C23. Expected \'fetchData\' to be at L4:C10.  attribute-indentation\n  3:54  error  Incorrect indentation of attribute \'updateLocation\' beginning at L3:C54. Expected \'updateLocation\' to be at L5:C10.  attribute-indentation\n  3:94  error  Incorrect indentation of close curly braces \'}}\' for the component \'{{search-input}}\' beginning at L3:C94. Expected \'{{search-input}}\' to be at L6:C8.  attribute-indentation\n  4:24  error  Incorrect indentation of attribute \'strUrlGif\' beginning at L4:C24. Expected \'strUrlGif\' to be at L5:C10.  attribute-indentation\n  4:44  error  Incorrect indentation of attribute \'currentWeather\' beginning at L4:C44. Expected \'currentWeather\' to be at L6:C10.  attribute-indentation\n  4:70  error  Incorrect indentation of attribute \'currentLocation\' beginning at L4:C70. Expected \'currentLocation\' to be at L7:C10.  attribute-indentation\n  4:97  error  Incorrect indentation of close curly braces \'}}\' for the component \'{{search-result}}\' beginning at L4:C97. Expected \'{{search-result}}\' to be at L8:C8.  attribute-indentation\n  2:4  error  Incorrect indentation for `<div>` beginning at L2:C4. Expected `<div>` to be at an indentation of 2 but was found at 4.  block-indentation\n  3:8  error  Incorrect indentation for `{{search-input}}` beginning at L3:C8. Expected `{{search-input}}` to be at an indentation of 6 but was found at 8.  block-indentation\n  4:8  error  Incorrect indentation for `{{search-result}}` beginning at L4:C8. Expected `{{search-result}}` to be at an indentation of 6 but was found at 8.  block-indentation\n  9:4  error  Incorrect indentation for `<p>` beginning at L9:C4. Expected `<p>` to be at an indentation of 2 but was found at 4.  block-indentation\n  9:30  error  links with target="_blank" must have rel="noopener"  link-rel-noopener\n');
  });

  QUnit.test('weather-gifs/templates/components/search-input.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'weather-gifs/templates/components/search-input.hbs should pass TemplateLint.\n\nweather-gifs/templates/components/search-input.hbs\n  2:12  error  Incorrect indentation of attribute \'value\' beginning at L2:C12. Expected \'value\' to be at L3:C6.  attribute-indentation\n  2:27  error  Incorrect indentation of attribute \'enter\' beginning at L2:C27. Expected \'enter\' to be at L4:C6.  attribute-indentation\n  2:57  error  Incorrect indentation of attribute \'input\' beginning at L2:C57. Expected \'input\' to be at L5:C6.  attribute-indentation\n  2:87  error  Incorrect indentation of attribute \'placeholder\' beginning at L2:C87. Expected \'placeholder\' to be at L6:C6.  attribute-indentation\n  2:118  error  Incorrect indentation of attribute \'class\' beginning at L2:C118. Expected \'class\' to be at L7:C6.  attribute-indentation\n  2:139  error  Incorrect indentation of close curly braces \'}}\' for the component \'{{input}}\' beginning at L2:C139. Expected \'{{input}}\' to be at L8:C4.  attribute-indentation\n  2:4  error  Incorrect indentation for `{{input}}` beginning at L2:C4. Expected `{{input}}` to be at an indentation of 2 but was found at 4.  block-indentation\n');
  });

  QUnit.test('weather-gifs/templates/components/search-result.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'weather-gifs/templates/components/search-result.hbs should pass TemplateLint.\n\nweather-gifs/templates/components/search-result.hbs\n  2:4  error  Incorrect indentation for `<img>` beginning at L2:C4. Expected `<img>` to be at an indentation of 2 but was found at 4.  block-indentation\n  3:4  error  Incorrect indentation for `<h1>` beginning at L3:C4. Expected `<h1>` to be at an indentation of 2 but was found at 4.  block-indentation\n');
  });
});
define('weather-gifs/tests/lint/tests.lint-test', [], function () {
  'use strict';

  QUnit.module('ESLint | tests');

  QUnit.test('integration/components/search-input-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/search-input-test.js should pass ESLint\n\n');
  });

  QUnit.test('integration/components/search-result-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/search-result-test.js should pass ESLint\n\n');
  });
...
define('weather-gifs/tests/test-helper', ['weather-gifs/app', 'weather-gifs/config/environment', '@ember/test-helpers', 'ember-qunit'], function (_app, _environment, _testHelpers, _emberQunit) {
  'use strict';
...
require('weather-gifs/tests/test-helper');
